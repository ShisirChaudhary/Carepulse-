...
// Admin dashboard plus add/edit/delete/unlock for patient accounts
@WebServlet("/admin")
public class AdminServlet extends HttpServlet {
    ...
    // Handles both add and edit submissions from user-form.jsp
    private void saveUser(HttpServletRequest req, HttpServletResponse resp)
        ...
        // Echo back the input so the user does not have to retype on validation errors

...
// Service class for the contact_inquiries table.
public class InquiryService {
    ...
    // Returns every inquiry ordered by the date received (newest first).
    public List<Inquiry> getAll() throws Exception {
        return getAll(null, null);
    }

    // Returns every inquiry with the specified sort key and direction.
    // Allowed sort keys: name, email, subject, received, status.
    ...
    // Returns the number of open inquiries, used by the admin dashboard.
    ...
    // Maps the current row of the result set into an Inquiry object.
